...
PARAM_BOUNDS = {
    'x': (5, 30),              # RSI 기간
    'overbought': (70.0, 99.9), # 과매수 (반드시 oversold보다 커야 함)
    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            for ind in offspring:
                ...
                # (현재 Bounds 설정상 겹치지 않지만, 로직의 안전성을 위해 추가)
                if ind[1] <= ind[2]:
...
def run_RSI_ga_optimization(
    ...
    # [수정] evaluate 함수 등록 (param_bounds 제거)
