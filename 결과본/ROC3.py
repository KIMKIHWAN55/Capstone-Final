...
# [신규] 개체 순서에 맞는 바운드 리스트 (min, max, type)
BOUNDS_LIST = [
...
# [신규] 파라미터 범위 및 제약조건(Long > Short) 강제 데코레이터
...
def generate_roc_signals_divergence(
    ...
    # 1. 장기/단기 ROCP 계산 (Equilibrium = 100)
    # ROCR은 비율(Price/PrevPrice)이므로 * 100을 해야 100 기준이 됨
